...
func mapFn(data []byte) [][sha256.Size]byte {
	...
	for _, cn := range parsedCert.DNSNames {
		...
		// TODO(mhutchinson): This is the most controversial part - the eTLD evolves.
		// We can lock this down with WASM, but what to do when the ecosystem needs the new changes?
